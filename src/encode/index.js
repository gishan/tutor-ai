...
const intent = {
	proximity_index: 2,
	proximity_related_to: ["x_end", "y_start"],
	proximity_sentence: "...",
	text: "20",
	color: "#000000",
	topic: "textTool",
...
// const encode = (intent, learningObjective, slide) => {
const encode = () => {
  const position = findIntent(intent, slide);
  return {
    message: {
      ...
      update: {
        text: {
          position: position,
          message: intent.text,
          // slideKey: `${learningObjective}-${slide.position}`,
          colour: intent.color,
        },
      },
      topic: intent.topic,
